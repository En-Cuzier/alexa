...
module.exports = {
    ...
    CAPTIONS: process.env.CAPTIONS === undefined ? 'ᴍᴀᴅᴇ ʙʏ ǫᴜᴇᴇɴ ᴀʟᴇxᴀ' : process.env.CAPTIONS,
    DISBGM: process.env.DISABLE_JID_BGM_FILTER === undefined ? false : process.env.DISABLE_JID_BGM_FILTER,
    STICKERP: process.env.AUTO_STICKER === undefined ? true : convertToBool(process.env.AUTO_STICKER),
    DISSTICKER: process.env.DISABLE_STICKER === undefined ? false : process.env.DISABLE_STICKER,
    BOT_NAME: process.env.BOT_NAME === undefined ? 'Queen 🧝‍♀️ Alexa' : process.env.BOT_NAME,
    ...
    MENU_LOGO: process.env.MENU_LOGO === undefined ?'https://telegra.ph/file/396c61e17c0c1091aa867.jpg' : process.env.MENU_LOGO,
    ...
    EMOJI_DESCRIPTION: process.env.EMOJI_DESCRIPTION === undefined ? '🕊' : process.env.EMOJI_DESCRIPTION,
    ...
    MENU_INFO: process.env.MENU_INFO === undefined ?'queen ᴀʟᴇxᴀ ɪꜱ ᴀ ᴘᴏᴡᴇʀꜰᴜʟʟ ʙᴏᴛ ꜰᴏʀ ᴡʜᴀᴛꜱᴀᴘᴘ. ᴅᴇᴠᴇʟᴏᴘᴇᴅ ʙʏ ᴛᴇᴇɴᴜ Use ᴇᴀꜱʏ ᴀɴᴅ ᴡᴏʀᴋɪɴɢ ᴘᴇʀᴇᴄᴛʟʏ..ꜱᴏ ᴀᴍᴀᴢᴏɴᴇ ᴀʟᴇxᴀ ɪꜱ ʙᴇꜱᴛ ᴡʜᴀᴛꜱᴀᴘᴘ ʙᴏᴛ!!' : process.env.MENU_INFO,
    BRANCH: 'master',
    HEROKU: {
