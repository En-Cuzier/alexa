...
Amdi.operate({ pattern: 'yvideo ?(.*)', fromMe: LOL,  deleteCommand: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    var ytsong = await axios.get(ytdata[0].link, { responseType: 'arraybuffer' })
    ...
    await message.client.sendMessage(message.jid,Buffer.from(ytsong.data), MessageType.document, {quoted: message.data, filename: ytdata[0].title + '.mp3', mimetype: 'audio/mpeg'});
...
Amdi.operate({ pattern: 'yvideo ?(.*)', fromMe: LOL,  deleteCommand: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    await message.client.deleteMessage(message.jid, {id: downloading.key.id, remoteJid: message.jid, fromMe: true});
    var uploading = await message.client.sendMessage(message.jid,Lang.UPLOADING_SONG,MessageType.text, {quoted: message.data});
    await message.client.sendMessage(message.jid,Buffer.from(ytsong.data), MessageType.audio, {mimetype: Mimetype.mp4Audio, ptt: false, quoted: message.data});
    return await message.client.deleteMessage(message.jid, {id: uploading.key.id, remoteJid: message.jid, fromMe: true})
}))
...
Amdi.operate({ pattern: 'yvideo ?(.*)', fromMe: LOL,  deleteCommand: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    const buttons = [
        {buttonId: BUTTHANDLE + 'qavideohd ' + ytLink, buttonText: {displayText: '720p' }, type: 1},
        {buttonId: BUTTHANDLE + 'qavideosd ' + ytLink, buttonText: {displayText: '360p' }, type: 1}
    ]
    const buttonMessage = {
        contentText: VIDYT,
...
Amdi.operate({ pattern: 'qavideohd ?(.*)', fromMe: LOL,  deleteCommand: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    var ytvid = await axios.get(ytdata.dl_link, { responseType: 'arraybuffer' })
    await message.client.deleteMessage(message.jid, {id: downloading.key.id, remoteJid: message.jid, fromMe: true});
    var uploading = await message.client.sendMessage(message.jid,Lang.UPLOADING_VIDEO,MessageType.text, {quoted: message.data});
    await message.client.sendMessage(message.jid,Buffer.from(ytvid.data), MessageType.video, {mimetype: Mimetype.mp4, quoted: message.data, caption: Build.CAP, thumbnail: qathmub});
    return await message.client.deleteMessage(message.jid, {id: uploading.key.id, remoteJid: message.jid, fromMe: true})
}))
...
Amdi.operate({ pattern: 'qavideosd ?(.*)', fromMe: LOL,  deleteCommand: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    var downloading = await message.client.sendMessage(message.jid,Lang.DOWNLOADING_VIDEO,MessageType.text, {quoted: message.data})
    var ytvid = await axios.get(ytdata[0].link, { responseType: 'arraybuffer' })
    await message.client.deleteMessage(message.jid, {id: downloading.key.id, remoteJid: message.jid, fromMe: true});
    var uploading = await message.client.sendMessage(message.jid,Lang.UPLOADING_VIDEO,MessageType.text, {quoted: message.data});
    await message.client.sendMessage(message.jid,Buffer.from(ytvid.data), MessageType.video, {mimetype: Mimetype.mp4, quoted: message.data, caption: Build.CAP, thumbnail: qathmub});
    return await message.client.deleteMessage(message.jid, {id: uploading.key.id, remoteJid: message.jid, fromMe: true})
