...
module.exports = {
    ...
    DEVELOPER_TAG: process.env.DEVELOPE_TAG === undefined ? '🧝‍♀️ Queen Alexa' : process.env.DEVELOPE_TAG,
    DEVELOPER_STATUS : process.env.DEVELOPER_STATUS === undefined ? '🧝‍♀️ᴾᴼᵂᴱᴿᴱᴰ ᴮʸ qᵘᵉᵉⁿ ᵃˡᵉˣᵃ' : process.env.DEVELOPER_STATUS,
