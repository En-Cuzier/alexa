...
MyPnky.addCommand({pattern: 'update$', fromMe: true, dontAddCommandList: true, desc: Lang.UPDATER_DESC}, (async (message, match) => {
    ...
    var webimage = await axios.get(`https://telegra.ph/file/f197db9fc5dd89b9cf2d7.jpg`, { responseType: 'arraybuffer' })
        ...
        await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg  , caption: "*New Update Avalible For Alexa. Type* .update now"+ newzel })
